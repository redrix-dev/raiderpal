  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="rounded-lg border border-slate-800 bg-panel-texture p-4 space-y-2">
          <h3 className="text-lg font-semibold text-warm font-condensed">
            Item Browser
          </h3>
          ...
          <Link
            href="/items/browse"
            className="inline-flex items-center justify-center gap-2 rounded-md border border-slate-800 bg-slate-900/60 px-3 py-2 text-sm font-medium text-[#4fc1e9] transition hover:border-slate-700 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-[#4fc1e9] focus:ring-offset-2 focus:ring-offset-slate-950"
          >
            Go to Item Browser
          </Link>
        </div>
      ...
      <details className="rounded-lg border border-slate-800 bg-panel-texture p-4 text-sm text-warm">
        <summary className="cursor-pointer text-warm font-semibold font-condensed tracking-wide uppercase">
          About Raider Pal
        </summary>
        <div className="mt-3 space-y-2 text-warm">
          <p>

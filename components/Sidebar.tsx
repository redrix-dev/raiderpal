...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:block w-60 flex-shrink-0">
      <div className="sticky top-4 space-y-4 rounded-lg border-border-strong bg-panel-texture p-3 text-sm">
        {/* Main nav */}
        <div>
          ...
          <nav className="space-y-1 text-xs">
            <Link
              href="/"
              className="block rounded px-2 py-1 text-primary hover:bg-surface-base"
            >
              Home
            </Link>
            <Link

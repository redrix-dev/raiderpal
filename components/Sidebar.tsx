...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:block w-60 flex-shrink-0">
      <div className="sticky top-4 space-y-4 rounded-lg border border-slate-800 bg-slate-950/80 p-3 text-sm">
        {/* Main nav */}
        <div>
          ...
          <nav className="space-y-1 text-xs">
            <Link
              href="/"
              className="block rounded px-2 py-1 text-gray-200 hover:bg-slate-900"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              href="/items"
              className="block rounded px-2 py-1 text-gray-400 hover:bg-slate-900"
            >
              Dev item list
            </Link>
          </nav>

  ...
  return (
    <div className="flex items-center justify-end gap-2 sm:gap-3">
      ...
      <button
        ...
        className="inline-flex items-center gap-2 rounded-md border border-border-subtle bg-brand-amber px-3 h-10 text-xs sm:text-sm font-medium text-primary transition hover:border-brand-cyan/60 hover:bg-brand-amber/70 focus:outline-none focus:ring-2 focus:ring-brand-cyan focus:ring-offset-2 focus:ring-offset-surface-base whitespace-nowrap"
      >
